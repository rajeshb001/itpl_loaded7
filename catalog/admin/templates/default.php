...
<body class="clearfix with-menu with-shortcuts">
  ...
  if ($lC_Template->hasPageWrapper()) {
    ...
    <ul id="shortcuts" role="complementary" class="children-tooltip tooltip-right" style="z-index:2;">
	  ...
	  <li id="sc-restrict_shipping"><a href="<?php echo lc_href_link_admin(FILENAME_DEFAULT, 'restrict_shipping'); ?>" class="shortcut-restrict_shipping" title="<?php echo $lC_Language->get('icon_restrict_shipping'); ?>"><?php echo $lC_Language->get('icon_restrict_shipping'); ?></a></li>
    </ul>
