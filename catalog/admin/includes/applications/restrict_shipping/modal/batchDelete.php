...
function batchDelete() {
  ...
  $.modal({
    content: '<div id="batchDelete">'+
             ...
             '    <p id="batchDeleteConfirmMessage"><?php echo $lC_Language->get('introduction_batch_delete_shipping_rule'); ?></p>'+
             '  </div>'+
             '</div>',
    title: '<?php echo $lC_Language->get('modal_heading_batch_delete_shipping_rule'); ?>',
    width: 300,
    actions: {
      'Close' : {
        color: 'red',
