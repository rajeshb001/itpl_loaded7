...
class lC_Restrict_shipping_Admin_rpc {
 /*
  ...
  */
  public static function getAll() {
    $result = lC_Restrict_shipping_Admin::getAll();
  ...
  */
  public static function getFormData() {  
    $result = lC_Restrict_shipping_Admin::formData($_GET['bid']);
    $result['rpcStatus'] = RPC_STATUS_SUCCESS;
  ...
  */
  public static function deleteEntry() {
    $result = array();
    $deleted = lC_Restrict_shipping_Admin::delete($_GET['bid']);
    if ($deleted) {
      $result['rpcStatus'] = RPC_STATUS_SUCCESS;
    }
  ...
  */
  public static function batchDeleteEntries() {
    $result = array();
    $deleted = lC_Restrict_shipping_Admin::batchDelete($_GET['batch']);
    if ($deleted) {
      $result['rpcStatus'] = RPC_STATUS_SUCCESS;
    }
