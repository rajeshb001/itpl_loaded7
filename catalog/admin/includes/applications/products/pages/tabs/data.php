...
<div id="section_data_content" class="with-padding">
  ...
  <fieldset class="fieldset">
	...
	<fieldset class="fieldset">
		<legend class="legend"><?php echo $lC_Language->get('text_shipping_rule_setting'); ?></legend>
			<div class="columns no-margin-bottom">
				<div class="new-row-mobile six-columns six-columns-tablet twelve-columns-mobile mid-margin-bottom">
				<div class="twelve-columns no-margin-bottom strong">
				  <span><?php echo $lC_Language->get('text_shipping_rule'); ?></span><?php echo lc_show_info_bubble($lC_Language->get('info_shipping_rule')); ?>
				</div>
				<div class="twelve-columns no-margin-bottom small-margin-top">
				  <?php echo lc_draw_pull_down_menu('shipping_rule_id', $shipping_rule_array, (isset($pInfo) ? $pInfo->getInt('shipping_rule_id') : null), 'class="select full-width small-margin-top" id="tax_class0"'); ?>
				</div>
				</div>
			</div>
		</legend>
